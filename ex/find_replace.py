...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='''DESCRIPTION:
            Find and replace recursively from the given folder using regular expression''',
    ...
    parser.add_argument('--search_regex', '-s',
                        help='search regex',required=True)

    parser.add_argument('--replace_regex', '-r',
                        help='replacement regex', required=True)
    ...
    parser.add_argument('--dryrun', '-dr',
                        action='store_true',
                        help="don't replace anything just show what is going to be",
                        default=False)
